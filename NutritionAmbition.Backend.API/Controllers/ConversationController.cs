...
namespace NutritionAmbition.Backend.API.Controllers
{
    ...
    public class ConversationController : ControllerBase
    {
        ...
        [AllowAnonymous]
        public async Task<ActionResult<BotMessageResponse>> StartConversation([FromBody] StartConversationRequest request)
        {
            ...
            _logger.LogInformation("Starting conversation with message: {MessageContent}", request.MessageContent);
            var response = await _conversationService.GenerateInitialBotReplyAsync(request.MessageContent);
